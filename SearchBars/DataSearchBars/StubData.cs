...
namespace DataSearchBars
{
    public class StubData : IDataManager
    {
        public IEnumerable<IUser> loadUsers()
        {
            ...
            list.Add(new User("trololo", "123456", "Kevin", "Jean", Sexe.Homme, new DateTime(1980, 1, 9), "0654856952", "St Julien De Copel", TypeBoisson.Biere, photo: "Images/ImagesProfils/trololo.jpg"));
